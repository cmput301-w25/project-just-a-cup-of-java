...
public class MoodHistoryAdapter extends RecyclerView.Adapter<MoodHistoryAdapter.MoodViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MoodViewHolder holder, int position) {
        ...
        holder.editButton.setOnClickListener(v -> {
            // Optional: Implement edit logic if needed
        });
    }
    ...
    public static class MoodViewHolder extends RecyclerView.ViewHolder {
        TextView dateTextView, emotionTextView, detailsTextView, triggerTextView, socialSituation;
        ...
        public MoodViewHolder(@NonNull View itemView) {
            ...
            viewImageButton = itemView.findViewById(R.id.viewImageButton); // NEW
        }
    }
