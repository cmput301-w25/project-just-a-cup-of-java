...
public final class DialogLoginBinding implements ViewBinding {
  ...
  private DialogLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button cancelButton,
  ...
  public static DialogLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogLoginBinding((ConstraintLayout) rootView, cancelButton, emailEditText,
          forgotPasswordText, loginButton, passwordEditText);
    }
