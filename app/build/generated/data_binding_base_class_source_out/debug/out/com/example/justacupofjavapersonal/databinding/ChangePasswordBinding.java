...
public final class ChangePasswordBinding implements ViewBinding {
  ...
  private ChangePasswordBinding(@NonNull LinearLayout rootView, @NonNull ImageView backArrow,
      @NonNull Button changePasswordButton, @NonNull EditText confirmPasswordEditText,
      @NonNull TextView confirmPasswordLabel, @NonNull EditText passwordEditText,
  ...
  public static ChangePasswordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ChangePasswordBinding((LinearLayout) rootView, backArrow, changePasswordButton,
          confirmPasswordEditText, confirmPasswordLabel, passwordEditText, passwordLabel);
    }
